...
import { QuizBreakdown } from './analytics/QuizBreakdown';
import { PerformanceDistribution, CategoryPerformanceChart } from './analytics/PerformanceDistribution';
...
function calculateOverallStats(quizAttempts: QuizAttempts[]) {
  ...
  ).filter(score => score >= 0); // Filter out any invalid scores
